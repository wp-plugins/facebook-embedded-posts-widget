...
Tags: Facebook post, facebook embedd post, facebook embedded post widget, wordpress widget
...
Start embedding your facebook post on your website right way.

Features:

It's free and always will be.

Can customize width, border color, border shadow, outline color, border radius.

Advanced customization can be done using wordpress easy to click widget area options.
